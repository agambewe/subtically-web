<template>
    <v-container dark>
        <v-container grid-list-md mb-0>
            <h1 class="text-md-center" style="font-family: 'Share Tech Mono';text-shadow: -2px 4px 4px silver">My Video</h1>
                            ...
                            <v-layout row>
                                ...
                                <v-flex xs9>
                                    <v-card-title primary-title>
                                            {{ this.detail.title }}
                                        <v-card-text>
                                            <span class="grey--text">@{{this.detail.name}} - {{this.detail.date_only}}</span>
